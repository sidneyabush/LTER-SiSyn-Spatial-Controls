...
desired_land_order <- c("Forest", "Grassland_Shrubland", "Cropland", "Impervious", "Bare", "Wetland_Marsh", "Ice")
display_labels <- c(
  "Forest" = "Forest",
...
# Run builder for canonical file
build_and_save_for_df(combined_df, file_suffix = "", use_ext = FALSE)
