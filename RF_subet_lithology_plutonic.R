...
drivers_df <- drivers_df[drivers_df$major_rock %like% "plutonic",]
...
lm_plot <- plot(rf_model2$predicted, drivers_df$med_si, xlab="Predicted", ylab="Observed", 
                main= "Optimized RF Model - Plutonic Rocks") + abline(a=0, b=1, col="red") + theme(text = element_text(size=20))
