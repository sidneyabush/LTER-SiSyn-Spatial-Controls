...
drivers_df <- read.csv("AllDrivers_Harmonized_20241108_WRTDS_MD_KG_NP_GenConc_Average.csv") %>%
...
write.csv(drivers_df, "AllDrivers_Harmonized_20241108_WRTDS_MD_KG_NP_GenConc_silicate_weathering.csv", row.names = FALSE)
