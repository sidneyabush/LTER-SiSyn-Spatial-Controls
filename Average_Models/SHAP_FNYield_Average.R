...
load("FNYield_Ave_rf_model2.RData")
load("FNYield_Ave_kept_drivers.RData")
load("FNYield_Ave_drivers_df.RData")
...
output_file <- sprintf("%s/FNYield_Ave_Overall_SHAP_Variable_Importance.pdf", output_dir)
...
create_shap_partial_dependence_plots <- function(shap_values, kept_drivers, drivers_df, output_dir, color_var = "FNYield") {
  ...
  pdf(file = file.path(output_dir, "FNYield_Ave_SHAP_Partial_Dependence_Plots.pdf"), width = 8, height = 8)
